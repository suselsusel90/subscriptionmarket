...
app.post('/registration', async (req, res) => {
    ...
    try {
        ...
        if (err && err.code === 11000) {
            res.json({
                message: 'Вы создали дубликат!'
            })
                .status(400)
            console.error('Вы создали дубликат!')
    ...
    res.json({
        message: 'Вы успешно зарегистрировались на этом сайте!'
    })
})
...
app.post('/user/changeEmail', async (req, res) => {
    ...
    res.json({
        message: 'E-Mail изменён! Для применения изменений заново авторизуйтесь на нашем сайте!',
        newEmail: user.email
    })
})
